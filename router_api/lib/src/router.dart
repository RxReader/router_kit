...
class Router {
  ...
  Map<String, Interceptor> get routeInterceptors =>
      Map<String, Interceptor>.unmodifiable(_routeInterceptors);
  ...
  void useRoute({
    ...
    assert(!_names.containsKey(routeName) &&
        !_routes.containsKey(routeName) &&
        !_routeInterceptors.containsKey(routeName));
  ...
  void useController({
    ...
    useRoute(
      ...
      routeName: controller['routeName'] as String,
      routeBuilder: controller['routeBuilder'] as WidgetBuilder,
      interceptor: interceptor,
    );
  }
}
